...
const Service = () => {
  return (
    <div className="services">
      <h1 className="majortitle">Terms of Services</h1>

      <div className="rte">
        <p>
          OVERVIEW
          <br /> <br />
          This website is operated by Kushal's Fashion Jewellery. Throughout the
          site, the terms “we”, “us” and “our” refer to Kushal's Fashion
          Jewellery. Kushal's Fashion Jewellery offers this website, including
          ...
          by hyperlink. These Terms of Service apply&nbsp; to all users of the
          ...
          <br /> <br />
          {/* Continue converting the sections similarly */}
        </p>
      </div>
    </div>
  );
